...
**중요: 영상이 외국어(영어, 일본어, 중국어 등)로 되어 있다면, 모든 내용을 한국어로 번역하여 제공해주세요. 제목, 내용, 핵심 포인트 등 모든 부분을 한국어 사용자가 이해하기 쉽게 자연스러운 한국어로 번역하되, 원본의 의미와 뉘앙스를 최대한 보존해주세요.**
...
**언어 처리 정보**
영상이 외국어였다면 맨 마지막에 다음과 같이 표시해주세요:
---
🌍 **번역 정보**: 이 영상은 [원본 언어]로 제작되었으며, 한국어로 번역하여 요약했습니다.
